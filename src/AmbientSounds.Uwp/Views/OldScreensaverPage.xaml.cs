...
public sealed partial class OldScreensaverPage : Page
{
    private const int SecondsToHide = 5;
    private readonly DisplayRequest _displayRequest;
    private readonly DispatcherQueue _dispatcherQueue;

    public OldScreensaverPage()
    {
    ...
    protected override async void OnNavigatedTo(NavigationEventArgs e)
    {
        ...
        telemetry.TrackPageView(nameof(OldScreensaverPage));
    ...
    private void GoBack()
    {
        ...
        navigator.GoBack(nameof(OldScreensaverPage));
    }
