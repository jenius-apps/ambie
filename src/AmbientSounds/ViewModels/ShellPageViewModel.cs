...
public partial class ShellPageViewModel : ObservableObject
{
        ...
        IAppStoreUpdater appStoreUpdater)
    {
        ...
        MenuItems.Add(new MenuItem(NavigateToPageCommand, "Channels", "\uE8B2", ContentPageType.Channels.ToString(), tooltipSubtitle: "View full screen slideshows or videos to help you relax or study."));
